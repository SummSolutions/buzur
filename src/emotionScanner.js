...
export function scanEmotion(text, options = {}) {
    ...
    const result = {
        ...
        reason: reasons[topCategory] || 'Emotional manipulation detected', detections,
    };

    logThreat(16, 'emotionScanner', result, text, logger);
    ...
    if (onThreat === 'throw') throw new Error(`Buzur blocked emotional manipulation: ${topCategory}`);
    return result;
}
